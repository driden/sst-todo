  ...
  "node_modules/aws-sdk/lib/util.js"(exports, module) {
    ...
    var util = {
      ...
      readFileSync: function readFileSync(path2) {
        if (util.isBrowser())
          return null;
        return __require("fs").readFileSync(path2, "utf-8");
      },
      base64: {
  ...
  "node_modules/aws-sdk/lib/shared-ini/ini-loader.js"(exports, module) {
    ...
    AWS2.IniLoader = AWS2.util.inherit({
      ...
      getDefaultFilePath: function getDefaultFilePath(isConfig) {
        return path2.join(this.getHomeDir(), ".aws", isConfig ? "config" : "credentials");
      },
...
var require_rdsdataservice = __commonJS({
  "node_modules/aws-sdk/lib/services/rdsdataservice.js"() {
    var AWS2 = require_core();
    AWS2.util.update(AWS2.RDSDataService.prototype, {
      retryableError: function retryableError(error) {
...
// node_modules/aws-sdk/apis/rds-data-2018-08-01.min.json
var require_rds_data_2018_08_01_min = __commonJS({
  "node_modules/aws-sdk/apis/rds-data-2018-08-01.min.json"(exports, module) {
    module.exports = {
      version: "2.0",
      metadata: {
...
// node_modules/aws-sdk/apis/rds-data-2018-08-01.paginators.json
var require_rds_data_2018_08_01_paginators = __commonJS({
  "node_modules/aws-sdk/apis/rds-data-2018-08-01.paginators.json"(exports, module) {
    module.exports = {
      pagination: {}
    };
  }
...
// node_modules/aws-sdk/clients/rdsdataservice.js
var require_rdsdataservice2 = __commonJS({
  "node_modules/aws-sdk/clients/rdsdataservice.js"(exports, module) {
    require_node_loader();
    var AWS2 = require_core();
    var Service = AWS2.Service;
    var apiLoader = AWS2.apiLoader;
    apiLoader.services["rdsdataservice"] = {};
    AWS2.RDSDataService = Service.defineService("rdsdataservice", ["2018-08-01"]);
    require_rdsdataservice();
    Object.defineProperty(apiLoader.services["rdsdataservice"], "2018-08-01", {
      get: function get() {
        var model = require_rds_data_2018_08_01_min();
        model.paginators = require_rds_data_2018_08_01_paginators().pagination;
        return model;
      },
      enumerable: true,
      configurable: true
    });
    module.exports = AWS2.RDSDataService;
  }
});

// node_modules/@serverless-stack/resources/dist/RDS_migrator/index.js
var import_rdsdataservice = __toESM(require_rdsdataservice2());
...
async function handler(evt) {
  ...
  const migrator = new Migrator({
    db,
    provider: new DynamicFileMigrationProvider(path.resolve(process.env.RDS_MIGRATIONS_PATH))
  });
  ...
  async getMigrations() {
    ...
    for (const fileName of files) {
      if (fileName.endsWith(".js") || fileName.endsWith(".cjs") || fileName.endsWith(".mjs")) {
        const [name] = path2.basename(fileName).split(".");
        const fullPath = path2.join(this.#migrationFolderPath, fileName);
